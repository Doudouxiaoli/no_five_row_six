...
public abstract class Mail {
	...
	public Mail(String smtp, String un, String pwd) {
		...
		this.mailProperties.put("mail.smtp.socketFactory.class", SSL_FACTORY);
		this.mailProperties.put("mail.smtp.port", "465");
		this.mailProperties.put("mail.smtp.socketFactory.port", "465");
